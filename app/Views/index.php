...
<?php echo $this->section('contenido'); ?>
    ...
    <div class="container">
      ...
      <div class="row row-cols-1 row-cols-md-2 align-items-md-center g-5 py-5">
        <div class="col d-flex flex-column align-items-start gap-2">
          ...
          <a href="#formulario_solicitud" class="btn btn-primary btn-lg"><i class="bi bi-table"></i> Formulario</a>
        </div>
        ...
        <div class="col">
          ...
          <div class="row row-cols-1 row-cols-sm-2 g-4">
            ...
            <div class="col d-flex flex-column gap-2">
              <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#reglamentoModal"><i class="bi bi-table"></i> Reglamento</button>
            ...
            <div class="col d-flex flex-column gap-2">
              <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#declaracionModal"><i class="bi bi-table"></i> Declaración</button>
              <h4 class="fw-semibold mb-0 text-body-emphasis">Featured title</h4>
              <p class="text-body-secondary">Paragraph of text beneath the heading to explain the heading.</p>
            </div>
  ...
  <!-- declaracion de principios modal -->
  <div class="modal fade" id="declaracionModal" tabindex="-1" aria-labelledby="declaracionModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-scrollable">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="container px-4 py-5">
            <h2 class="pb-2 border-bottom centrado"><img src="public/img/logos/logoPLN.jpg" style="max-width: 40px;" alt=""> DECLARACION DE PRINCIPIOS, P R O G R A M A, ESTATUTO OFICIAL DEL PARTIDO LIBERAL DE NICARAGUA</h2>
          ...
          <div class="accordion accordion-flush" id="accordionFlushExample">
            ...
            <div class="accordion-item">
              ...
              <div id="flush-collapseThree" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                <div class="accordion-body">
                  <p>Contenido de la justificación Lorem ipsum dolor sit amet consectetur adipisicing elit. Labore illum id dolor. Dolore at exercitationem veniam distinctio illo voluptatem sint enim accusamus quae eveniet tempora, beatae, alias natus laboriosam voluptate. Lorem ipsum dolor sit amet consectetur adipisicing elit. Exercitationem temporibus inventore natus reiciendis explicabo nam ut tempora, ea autem placeat, vero impedit illum ullam commodi eveniet accusantium deserunt sunt perferendis?Lorem ipsum dolor sit amet consectetur, adipisicing elit. Nam minus quasi ex libero saepe officiis sunt, provident sapiente a doloremque quam laborum quibusdam voluptate facilis placeat, modi quisquam possimus blanditiis. Lorem ipsum dolor sit amet consectetur adipisicing elit. Debitis, nostrum inventore sunt fugiat odio laborum praesentium temporibus ad illum nulla reprehenderit exercitationem at soluta dolore enim sit animi a saepe!</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <form action="<?= base_url('solicitudes/crear') ?>" method="POST" id="formulario_solicitud" name="formulario_solicitud" enctype="multipart/form-data" class="needs-validation" novalidate>
          ...
          <div class="row g-3">
            ...
            <div class="col-sm-6">
              ...
              <input type="text" class="form-control" id="afiliado_id" name="afiliado_id" placeholder="" value="<?= set_value('afiliado_id'); ?>">
            ...
            <div class="col-sm-2">
                <label for="estado_id" class="col-sm-2 col-form-label" style="text-align: right">
                    <!-- <?= lang('App.productos.grupo_productos') ?> -->
                     Estado
                </label>
                <div class="">
                    <select class="form-select" id="estado_id" name="estado_id" required1>
            ...
            <div class="col-sm-2">
                <label for="departamento_id" class="col-sm-2 col-form-label" style="text-align: right">
                    <!-- <?= lang('App.productos.grupo_productos') ?> -->
                     Departamento
                </label>
                <div class="">
                    <select class="form-select" id="departamento_id" name="departamento_id" required1>
                        <option value="">Seleccionar</option>
            ...
            <div class="col-md-2">
                ...
                <div class="">
                    <select class="form-select" id="municipio_id" name="municipio_id" required1>
                        <option value="">Seleccionar</option>
            ...
            <div class="col-sm-4">
              ...
              <input type="file" class="form-control" accept="image/jpeg, image/png" id="cedula_img" name="cedula_img" value="<?= set_value('cedula_img'); ?>">
              <p class="small" style="color:red">
            ...
            <div class="col-sm-2">
              ...
              <input type="text" class="form-control" id="pasaporte" name="pasaporte" value="<?= set_value('pasaporte'); ?>">
              <p class="small" style="color:red">
            ...
            <div class="col-sm-2">
              ...
              <input type="text" class="form-control" id="licencia" name="licencia" value="<?= set_value('licencia'); ?>">
              <p class="small" style="color:red">
            ...
            <div class="col-sm-2">
              ...
              <input type="text" class="form-control" id="residencia" name="residencia" value="<?= set_value('residencia'); ?>">
              <p class="small" style="color:red">
