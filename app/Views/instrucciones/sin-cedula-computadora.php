...
<?= $this->include('cabecera'); ?> 
    ...
    <div class="row">
        ...
        <div class="col-sm-4" style="margin-top: -115px;">
            ...
            <div class="container">
              <nav aria-label="breadcrumb">
                <ol class="container-breadcrumb breadcrumb breadcrumb-custom overflow-hidden text-center rounded-3">
                  ...
                  <li class="breadcrumb-item">
                    <a class="" href=<?= base_url() . "instrucciones/sin-cedula-computadora" ?> style="color: red;">
                        Instrucciones sin cédula para computadora
                    </a>
                  </li>
                </ol>
              </nav>
            ...
            <div>
                <?= $this->include('docs/sin-cedula-computadora'); ?>
            </div>
